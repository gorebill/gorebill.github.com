...
THREE.TrackballControlsEx = function ( object, domElement ) {
	...
	var _this = this,
	STATE = { NONE : -1, ROTATE : 2, ZOOM : 1, PAN : 0 };
	...
	this.getMouseProjectionOnBall = function ( clientX, clientY ) {
		...
		// important! i set this coz i wanna keep a overlook
		projection.setY(0).normalize(); // projection is a vector the mouse moved, so fixd y in a not-changing value
